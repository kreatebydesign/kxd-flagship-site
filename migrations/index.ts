...
import * as migration_20260811_proposal_contract_builder from './20260811_proposal_contract_builder';
import * as migration_20260812_proposal_lifecycle_package from './20260812_proposal_lifecycle_package';
import * as migration_20260813_commercial_documents from './20260813_commercial_documents';
...
export const migrations = [
  ...
  {
    up: migration_20260713_phase31c_reporting_facts.up,
    down: migration_20260713_phase31c_reporting_facts.down,
    name: '20260713_phase31c_reporting_facts',
  },
  {
  ...
  {
    up: migration_20260814_phase4_portal_identity_security.up,
    down: migration_20260814_phase4_portal_identity_security.down,
    name: '20260814_phase4_portal_identity_security',
  },
  {
  ...
  {
    up: migration_20260811_proposal_contract_builder.up,
    down: migration_20260811_proposal_contract_builder.down,
    name: '20260811_proposal_contract_builder',
  },
  {
    up: migration_20260812_proposal_lifecycle_package.up,
    down: migration_20260812_proposal_lifecycle_package.down,
    name: '20260812_proposal_lifecycle_package',
  },
  {
  ...
  {
    // Junior Creator timer safety — lastActivityAt + stopReason + automaticStopAt.
  ...
  {
    // Managed Client Lead Operations Phase 2 — client-inquiries ledger.
    // Additive only. Local apply until production migration is authorized.
    // Never writes into sales-leads. No commission columns.
    up: migration_20260830_managed_client_lead_operations.up,
    down: migration_20260830_managed_client_lead_operations.down,
    name: '20260830_managed_client_lead_operations',
  },
  {
    // Sales closed-loop V1 — lost reason on sales-leads.
    // Additive only. Local apply until production migration is authorized.

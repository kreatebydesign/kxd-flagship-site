...
| **Product Intelligence** | **KXD Product Intelligence (internal control plane)** | **P0-A approved; P0-B through P0-J complete** | Spec: `docs/KXD-PRODUCT-INTELLIGENCE.md`. Contracts through Future Bets Engine in `lib/product-intelligence/`. Verifiers: `verify:product-intelligence-p0b` … `p0j`. Not client-facing. Observation/entry stores empty through Fame, Kill List, and Future Bets; Competitive / valuation still empty. Next: **P0-K** automation drafts when authorized. |
...
| `KXD-PRODUCT-INTELLIGENCE.md` | Product Intelligence control plane — P0-A, P0-B, P0-C, P0-D, P0-E, P0-F, P0-G, P0-H, P0-I, P0-J (through Future Bets Engine) |

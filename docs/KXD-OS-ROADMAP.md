...
| **Product Intelligence** | **KXD Product Intelligence (internal control plane)** | **P0-A approved; P0-B, P0-C, P0-D, P0-E, P0-F complete** | Spec: `docs/KXD-PRODUCT-INTELLIGENCE.md`. Contracts + inventory + Decision Archive + Platform Health Engine + Founder Friction Engine in `lib/product-intelligence/`. Verifiers: `verify:product-intelligence-p0b` … `p0f`. Not client-facing. Health scores unobserved; friction observations empty; Hall of Fame / Kill List / Future Bets still empty. Next: **P0-G** Release Ledger when authorized. |
...
| `KXD-PRODUCT-INTELLIGENCE.md` | Product Intelligence control plane — P0-A, P0-B, P0-C, P0-D, P0-E, P0-F (through Founder Friction) |

...
| **Product Intelligence** | **KXD Product Intelligence (internal control plane)** | **P0-A approved; P0-B, P0-C, P0-D, P0-E complete** | Spec: `docs/KXD-PRODUCT-INTELLIGENCE.md`. Contracts + inventory + Decision Archive + Platform Health Engine in `lib/product-intelligence/`. Verifiers: `verify:product-intelligence-p0b` … `p0e`. Not client-facing. Health scores unobserved (no invented numbers); Hall of Fame / Kill List / Future Bets / Friction still empty. Next: **P0-F** Founder Friction when authorized. |
...
| `KXD-PRODUCT-INTELLIGENCE.md` | Product Intelligence control plane — P0-A–E (through Platform Health Engine) |

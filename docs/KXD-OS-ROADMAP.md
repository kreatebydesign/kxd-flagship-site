...
| **Product Intelligence** | **KXD Product Intelligence (internal control plane)** | **P0-A approved; P0-B complete** | Spec: `docs/KXD-PRODUCT-INTELLIGENCE.md`. Contracts in `lib/product-intelligence/`. Verifier: `verify:product-intelligence-p0b`. Not client-facing. Stores empty (contracts only). Next: **P0-C** System Map auto-inventory when authorized. |
...
| `KXD-PRODUCT-INTELLIGENCE.md` | Product Intelligence control plane — P0-A law; P0-B contracts |

...
**KXD Product Intelligence** — **P0-A** architecture approved as product law; **P0-B** contracts complete; **P0-C** automatic inventory complete; **P0-D** Decision Archive initialized. Spec: `docs/KXD-PRODUCT-INTELLIGENCE.md`. Verifiers: `verify:product-intelligence-p0b` … `p0d`. Code: `lib/product-intelligence/` (+ `inventory/`, `archive/`).
...
- **P0-C:** `runAutomaticInventory()` discovers routes, APIs, collections, modules, features, editions, permissions, nav surfaces, integrations, verifiers, crons, jobs, AI capabilities, Shared Core
- **P0-D:** `loadDecisionArchive()` backfills 8 Edition 1 Decisions + linked Product DNA + Doctrine (Today home, Client Command, Shared Core, philosophy, Connect, connected storage, AI, Product Intelligence)
- Hall of Fame / Kill List / Future Bets / Founder Friction / Competitive / valuation remain **unpopulated**
- Next authorized batch: **P0-E** (Scorecard v1 + movement log) only when explicitly requested
...
6. **KXD Product Intelligence** — P0-A–D complete through Decision Archive initialization (`lib/product-intelligence/`). Next authorized batch is **P0-E** (Scorecard v1) only when explicitly requested. Spec: `docs/KXD-PRODUCT-INTELLIGENCE.md`. Do not populate Hall of Fame / Kill List / Future Bets / Friction / Competitive / valuation until authorized.
...
| `KXD-PRODUCT-INTELLIGENCE.md` | Product Intelligence — P0-A–D (law, contracts, inventory, Decision Archive) |

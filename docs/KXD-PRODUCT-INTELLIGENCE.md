...
**Experience law (external to this control plane):** Client-facing and operator emotional standards are governed by the **KXD Experience Constitution** (`docs/KXD-OS-CONSTITUTION.md` v2.0 — Held clarity). Experience Refinement Phase 2 Batch A (Constitution) and Batch B (Arrival → Today Emotional Arc) are complete (`docs/PHASE-2-EXPERIENCE-REFINEMENT.md`). Product Intelligence remains the institutional memory and build-authorization plane; the Experience Constitution remains the sole permanent law for how KXD OS feels. Do not expand Product Intelligence to absorb experience UI.

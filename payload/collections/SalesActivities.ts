  ...
  fields: [
    {
      ...
      options: [
        ...
        { label: "Commercial Trigger", value: "commercial-trigger" },
        { label: "Payment Promised", value: "payment-promised" },
        { label: "Renewal Notice", value: "renewal-notice" },
        { label: "Commission Follow-Up", value: "commission-follow-up" },
        { label: "Commercial Review", value: "commercial-review" },
      ],

...
import { BrandKitForm, type ClientOption, type ProjectOption } from "@/components/admin/creative/BrandKitForm";

export const metadata: Metadata = {
  title: "New Brand Kit · KXD Creative Engine",
...
export default async function NewBrandKitPage() {
  ...
  return <BrandKitForm clients={clients} projects={projects} />;
}

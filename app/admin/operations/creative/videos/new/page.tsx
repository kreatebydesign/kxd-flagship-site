...
import { VideoForm, type ClientOption, type ProjectOption, type CampaignOption } from "@/components/admin/creative/VideoForm";

export const metadata: Metadata = {
  title: "New Promo Video · KXD Creative Engine",
...
export default async function NewVideoPage() {
  ...
  return <VideoForm clients={clients} projects={projects} campaigns={campaigns} />;
}

...
import { SocialPostForm, type ClientOption, type ProjectOption, type CampaignOption } from "@/components/admin/creative/SocialPostForm";

export const metadata: Metadata = {
  title: "New Social Post · KXD Creative Engine",
...
export default async function NewSocialPostPage() {
  ...
  return <SocialPostForm clients={clients} projects={projects} campaigns={campaigns} />;
}

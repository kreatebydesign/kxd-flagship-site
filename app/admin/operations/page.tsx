...
export default function OperationsPage() {
  ...
  return (
    ...
    >
        ...
        <div className="mx-auto max-w-screen-xl" style={{ padding: "1.125rem 1.5rem" }}>
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              <Link
                href="/"
                aria-label="Kreate by Design Home"
      ...
      <div className="mx-auto max-w-screen-xl" style={{ padding: "2.5rem 1.5rem 4rem" }}>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_22rem] xl:gap-10">
              ...
              {PIPELINE.map((row, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderBottom:
                      i < PIPELINE.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
                    alignItems: "center",
                    minWidth: "520px",
                  }}
                >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
            <section>
              ...
              <div style={{ background: C.bgElevated, border: `1px solid ${C.border}` }}>
                ...
                {TASKS.map((task, i) => (
                  <div
                    ...
                    style={{
                      padding: "0.875rem 1.125rem",
                      borderBottom:
                        i < TASKS.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
                      display: "flex",
                      alignItems: "flex-start",
                      gap: "0.875rem",
                    }}
        ...
        >
          ...
          >
            KXD OS · Operations Dashboard · Phase 1 Placeholder — live Payload data integration in
            Phase 2.{" "}
            <Link
              href="/admin/collections/project-inquiries"

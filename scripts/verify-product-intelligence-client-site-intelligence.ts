...

{
  ...
  assert.equal(CLIENT_SITE_INTELLIGENCE_PRE_BUILD_GATE.saleConfirmationUiImplemented, false);
  assert.equal(CLIENT_SITE_INTELLIGENCE_PRE_BUILD_GATE.commissionUiImplemented, false);

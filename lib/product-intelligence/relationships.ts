...
export const ALLOWED_RELATIONSHIP_PATTERNS: readonly RelationshipPattern[] = [
  ...
  { from: "future_bet", kind: "related_to", to: "product_dna" },
  { from: "future_bet", kind: "related_to", to: "product_evolution" },
  { from: "future_bet", kind: "related_to", to: "product_inventory" },
  { from: "future_bet", kind: "related_to", to: "health_snapshot" },
  { from: "future_bet", kind: "related_to", to: "decision" },
  { from: "future_bet", kind: "cites", to: "evidence" },
  { from: "future_bet", kind: "related_to", to: "competitive_insight" },
  { from: "future_bet", kind: "moves", to: "valuation" },

...
Never paste secrets into public tools. Never share login links casually.`,
        ...
        operations: ops({
          ...
          yourResponsibility: [
            ...
            "Request a Decision before sharing sensitive material",
          ],
        ...
        bestPractices: ["When unsure, do not share — request a decision"],
        checklist: [
    ...
    lesson({
      ...
      workStage: "learn",
      content: {
        body: `Independently you may: view assigned work, update permitted records, prepare drafts, add internal notes, triage approved inbox items, propose schedules, complete training, and submit work for approval.
...
You may not: send externally without approval, change plans or entitlements, execute financial transactions, finalize pricing, delete material records, or approve your own work.`,
        ...
        bestPractices: ["If it changes money, access, or public content — prepare for review"],
        checklist: [
          { id: "independent", label: "I can list my independent actions", required: true },
        ],
        resources: [],
        images: [],
        knowledgeCheckPlaceholder: "Name two actions that always require approval.",
        practiceTaskPlaceholder: null,
        operationalPractice: null,
      },
    }),
    lesson({
      ...
      title: "What always requires approval",
      ...
      workStage: "learn",
      content: {
        body: `An authorized approver (currently Matt Lunger) decides: external messages, upgrades, access/entitlements, pricing and agreements, money movement, public publishing, restricted scheduling, deletions, role changes, and production configuration.`,
        walkthrough: [],
        steps: [],
        operations: ops({
        ...
        bestPractices: ["Draft → Check my work → Prepare for Review"],
        checklist: [
          { id: "gates", label: "I can name the always-approval categories", required: true },
        ],
        resources: [],
        images: [],
...
Financial command stays founder/admin authority.`,
    ...
    lesson({
      ...
      title: "Preparing work for approval",
...
Do not fabricate completion. Progress only when Matt confirms.`,
        ...
        bestPractices: ["Request explicit dry-run approval"],
        checklist: [
